...
SELF_SERVICE_API_REQUEST_PARAM_NAME_RECIPIENT_EMAIL = "recipient-email"
SELF_SERVICE_API_REQUEST_PARAM_NAME_RECIPIENT_MOBILE = "recipient-mobile"
SELF_SERVICE_API_REQUEST_KEYTALK_SVR_HOST_NAME = "svr-host-name"

SELF_SERVICE_API_RESPONSE_SUCCESSS = "success"
SELF_SERVICE_API_RESPONSE_ERROR = "error"
SELF_SERVICE_API_RESPONSE_STRINGS = [SELF_SERVICE_API_RESPONSE_SUCCESSS,
