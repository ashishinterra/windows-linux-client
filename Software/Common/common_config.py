...
AUTH_RESULT_STRINGS = [AUTH_OK, AUTH_DELAY, AUTH_LOCKED,
                       AUTH_EXPIRED, "_NOT_USED_", AUTH_CHALLENGE]
...
SERVER_SUPPORTED_RCDPV2_VERSIONS = [RCDP_VERSION_2_0, RCDP_VERSION_2_1, RCDP_VERSION_2_2]
